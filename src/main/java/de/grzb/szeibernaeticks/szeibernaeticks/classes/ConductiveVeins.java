...
import de.grzb.szeibernaeticks.szeibernaeticks.energy.IEnergyStorer;
import net.minecraft.nbt.NBTTagCompound;

public class ConductiveVeins implements ISzeibernaetick {

    private ConcurrentSet<IEnergyProducer> producers = new ConcurrentSet<>();
    private ConcurrentSet<IEnergyConsumer> consumers = new ConcurrentSet<>();
