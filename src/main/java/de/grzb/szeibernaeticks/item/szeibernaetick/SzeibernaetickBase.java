package de.grzb.szeibernaeticks.item.szeibernaetick;

import de.grzb.szeibernaeticks.control.Log;
import de.grzb.szeibernaeticks.control.LogType;
import de.grzb.szeibernaeticks.item.ItemBase;
...
import de.grzb.szeibernaeticks.szeibernaeticks.event.ISzeibernaetickEventHandler;
...
public class SzeibernaetickBase extends ItemBase {
    ...
    public SzeibernaetickBase(String name, Class<? extends ISzeibernaetick> capability,
            Class<? extends ISzeibernaetickEventHandler> handler) {
        this(name, capability, handler, CreativeTabs.COMBAT);
    }

    public SzeibernaetickBase(String name, Class<? extends ISzeibernaetick> capability,
            Class<? extends ISzeibernaetickEventHandler> handler, CreativeTabs tab) {
        super(name);
    ...
    /**
     * Returns a new instance of the ISzeibernaetick corresponding to this
     * ISzeibernaetick.
     *
