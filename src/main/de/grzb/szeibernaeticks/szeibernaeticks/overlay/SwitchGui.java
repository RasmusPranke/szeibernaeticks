...
public abstract class SwitchGui extends GuiScreen {
    ...
    protected void renderSwitch(int x, int y, float partialTicks, EntityPlayer player, Switch $switch) {
    ...
    public SwitchGui(Minecraft mc) {
        ...
        float partialTicks = 10;
        ResourceLocation WIDGETS_TEX_PATH = null;
        ...
        this.drawTexturedModalRect(i - 91 - 1 + entityplayer.inventory.currentItem * 20, sr.getScaledHeight() - 22 - 1,
                0, 22, 24, 22);
        ...
        for(int l = 0; l < 9; ++l) {
            ...
            this.renderSwitch(i1, j1, partialTicks, entityplayer, entityplayer.inventory.mainInventory.get(l));
        }
        ...
        if(!itemstack.isEmpty()) {
            ...
            if(enumhandside == EnumHandSide.LEFT) {
                this.renderSwitch(i - 91 - 26, l1, partialTicks, entityplayer, itemstack);
            }
            else {
                this.renderSwitch(i + 91 + 10, l1, partialTicks, entityplayer, itemstack);
            }
        }
